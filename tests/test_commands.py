...
from simpleclaw.cli.commands import app
from simpleclaw.config.schema import Config
from simpleclaw.providers.litellm_provider import LiteLLMProvider
from simpleclaw.providers.openai_codex_provider import _strip_model_prefix
from simpleclaw.providers.registry import find_by_model
...
def mock_paths():
    ...
    with patch("simpleclaw.config.loader.get_config_path") as mock_cp, \
         patch("simpleclaw.config.loader.save_config") as mock_sc, \
         patch("simpleclaw.config.loader.load_config") as mock_lc, \
         patch("simpleclaw.cli.commands.get_workspace_path") as mock_ws:
...
def test_onboard_fresh_install(mock_paths):
    ...
    assert "simpleclaw is ready" in result.stdout
...
def test_gateway_uses_config_directory_for_cron_store(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("simpleclaw.cron.service.CronService", _StopCron)
