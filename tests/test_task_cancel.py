...
def _make_loop():
    ...
    with patch("simpleclaw.agent.loop.ContextBuilder"), \
         patch("simpleclaw.agent.loop.SessionManager"), \
         patch("simpleclaw.agent.loop.SubagentManager") as MockSubMgr:
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        from simpleclaw.agent.subagent import SubagentManager
        from simpleclaw.bus.queue import MessageBus
        from simpleclaw.providers.base import LLMResponse, ToolCallRequest
        ...
        monkeypatch.setattr("simpleclaw.agent.tools.registry.ToolRegistry.execute", fake_execute)
