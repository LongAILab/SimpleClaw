...
from simpleclaw.cli import commands
...
def mock_prompt_session():
    ...
    with patch("simpleclaw.cli.commands._PROMPT_SESSION", mock_session), \
         patch("simpleclaw.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("simpleclaw.cli.commands.PromptSession") as MockSession, \
         patch("simpleclaw.cli.commands.FileHistory") as MockHistory, \
