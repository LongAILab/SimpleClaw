...
from simpleclaw.runtime.bootstrap import RuntimeServices, build_runtime_services
...
def run_api_server_with_runtime(
    *,
    ...
    console.print(f"{logo} Starting simpleclaw API on http://{host}:{port}")
    console.print(
