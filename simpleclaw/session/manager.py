...
from simpleclaw.config.paths import get_legacy_sessions_dir, sanitize_tenant_key
from simpleclaw.utils.helpers import ensure_dir, estimate_message_tokens, safe_filename
...
class SessionManager:
    ...
    def _get_legacy_session_path(self, key: str) -> Path:
        """Legacy global session path (~/.simpleclaw/sessions/)."""
        safe_key = safe_filename(key.replace(":", "_"))
