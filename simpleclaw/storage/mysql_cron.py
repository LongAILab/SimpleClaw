...
from simpleclaw.cron.repository import compute_next_run
from simpleclaw.cron.types import CronJob, CronJobState, CronPayload, CronSchedule
...
class MySQLCronRepository:
    ...
    def add_job(
        ...
        *,
        ...
        from simpleclaw.cron.repository import validate_schedule_for_add
        import uuid
