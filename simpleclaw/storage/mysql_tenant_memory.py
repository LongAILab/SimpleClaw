...
from simpleclaw.utils.helpers import get_default_tenant_memory_markdown
...
class MySQLTenantMemoryStore:
    ...
    _LEGACY_MEMORY_FOOTER = "*This file is automatically updated by nanobot when important information should be remembered.*"  # kept for migration compatibility
