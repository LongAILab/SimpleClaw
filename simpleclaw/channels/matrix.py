...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install simpleclaw[matrix]"
    ) from e
...
from simpleclaw.config.paths import get_data_dir, get_media_dir
from simpleclaw.utils.helpers import safe_filename
