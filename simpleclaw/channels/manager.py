...
from simpleclaw.channels.base import BaseChannel
...
class ChannelManager:
    ...
    async def start_all(self) -> None:
        ...
        for name in self.channels:
            ...
            self._channel_workers[name] = asyncio.create_task(self._channel_sender(name))
    ...
    async def stop_all(self) -> None:
        ...
        if self._dispatch_task:
            ...
            try:
                ...
                pass
        for task in self._channel_workers.values():
            task.cancel()
        for task in self._channel_workers.values():
            try:
                await task
    ...
    async def _dispatch_outbound(self) -> None:
        ...
        while True:
            try:
                ...
                if channel:
                    await self._outbound_queues[msg.channel].put(msg)
                else:
    ...
    async def _channel_sender(self, channel_name: str) -> None:
        """Serialise sends within one channel without blocking others."""
