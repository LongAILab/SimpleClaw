...
from simpleclaw.config.paths import get_media_dir
from simpleclaw.config.schema import WecomConfig
...
class WecomChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        if not WECOM_AVAILABLE:
            logger.error("WeCom SDK not installed. Run: pip install simpleclaw[wecom]")
            return
