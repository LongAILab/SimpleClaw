...
from simpleclaw.agent.memory import MemoryConsolidator, MemoryStore
from simpleclaw.agent.postprocess import PostprocessManager, PostprocessRunner
from simpleclaw.agent.runtime import TenantRuntime, TenantRuntimeManager
from simpleclaw.agent.scheduler import SessionEnvelope, SessionScheduler
...
from simpleclaw.agent.tools.spawn import SpawnTool
...
from simpleclaw.heartbeat.service import _HEARTBEAT_TOOL
from simpleclaw.providers.base import LLMProvider
from simpleclaw.session.manager import Session, SessionManager
from simpleclaw.session.primary_session import PrimarySessionStore
from simpleclaw.runtime.leases import LeaseRepository
from simpleclaw.tenant.state import TenantStateRepository

if TYPE_CHECKING:
    from simpleclaw.config.schema import ChannelsConfig, CronExecutionPolicy, ExecToolConfig, WebSearchConfig
...
class AgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from simpleclaw.agent.tools.mcp import connect_mcp_servers
        try:
    ...
    async def _handle_restart(self, msg: InboundMessage) -> None:
        ...
        async def _do_restart():
            ...
            os.execv(sys.executable, [sys.executable, "-m", "simpleclaw"] + sys.argv[1:])
