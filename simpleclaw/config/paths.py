...
from simpleclaw.config.loader import get_config_path
...
def get_workspace_path(workspace: str | None = None) -> Path:
    ...
    path = Path(workspace).expanduser() if workspace else Path.home() / ".simpleclaw" / "workspace"
...
def get_cli_history_path() -> Path:
    ...
    return Path.home() / ".simpleclaw" / "history" / "cli_history"


def get_bridge_install_dir() -> Path:
    """Return the shared WhatsApp bridge installation directory."""
    return Path.home() / ".simpleclaw" / "bridge"


def get_legacy_sessions_dir() -> Path:
    """Return the legacy global session directory used for migration fallback."""
    return Path.home() / ".simpleclaw" / "sessions"
