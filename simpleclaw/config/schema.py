...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.simpleclaw/workspace"
...
class RedisRuntimeConfig(Base):
    ...
    key_prefix: str = "simpleclaw"
    stream_prefix: str = "simpleclaw:tasks"
...
class Config(BaseSettings):
    """Root configuration for simpleclaw."""
    ...
    def get_api_base(
        ...
        from simpleclaw.providers.registry import find_by_name
    ...
    model_config = ConfigDict(env_prefix="SIMPLECLAW_", env_nested_delimiter="__")
