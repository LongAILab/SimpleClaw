...
class DevOrchestrator:
    ...
    def start_mysql(self) -> None:
        ...
        with conn.cursor() as cur:
            cur.execute("CREATE DATABASE IF NOT EXISTS nanobot CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci")
        conn.close()
    ...
    def _role_args(self, role: str) -> list[str]:
        args = [sys.executable, "-m", "nanobot", "serve", role]
        if role == "chat-api":
    ...
    def status(self) -> None:
        table = Table(title="nanobot dev services")
