...
from nanobot.config.paths import get_base_workspace_path, resolve_workspace_root
from nanobot.utils.helpers import build_assistant_message, detect_image_mime, estimate_message_tokens
...
Reply directly with text for conversations. Only use the 'message' tool to send to a specific chat channel."""
    ...
    def _download_remote_image(url: str) -> bytes | None:
        ...
        req = Request(url, headers={"User-Agent": "nanobot/1.0"})
        try:
